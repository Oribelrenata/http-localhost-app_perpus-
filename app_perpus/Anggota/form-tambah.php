    ...
    <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Tambah anggota baru</h2>
      <form action="proses-tambah.php" method="POST">
          <div class="w-full">
              ...
              <div class="w-full">
                  <label for="namalengkap" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Brand</label>
              ...
              <div class="sm:col-span-2">
                  ...
                  <textarea id="alamat" rows="8" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="$2999" required="">
              </div>
              <div>
